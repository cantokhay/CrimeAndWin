...
namespace CrimeAndWin.Shared.Constants
{
    /// <summary>
    ...
    public static class SeedDataConstants
    {
        ...
        // ---------------------------------------------------------
        public static readonly Guid TransactionAlpha1Id = Guid.Parse("80000000-0000-0000-0000-000000000001"); // Alpha: Suç ödülü (BlackBalance)
        public static readonly Guid TransactionAlpha2Id = Guid.Parse("80000000-0000-0000-0000-000000000002"); // Alpha: Para temizleme (CashBalance)
        public static readonly Guid TransactionBeta1Id  = Guid.Parse("80000000-0000-0000-0000-000000000003"); // Beta: Suç ödülü (BlackBalance)
        ...
        // Prefix: a0000000-0000-0000-0000-00000000000x (hex 'a' geçerlidir)
        // ---------------------------------------------------------
        public static readonly Guid ItemDesertEagleId  = Guid.Parse("a0000000-0000-0000-0000-000000000001"); // Alpha'nın silahı
        public static readonly Guid ItemKevlarVestId   = Guid.Parse("a0000000-0000-0000-0000-000000000002"); // Alpha'nın zırhı
        public static readonly Guid ItemAdrenalineId   = Guid.Parse("a0000000-0000-0000-0000-000000000003"); // Beta'nın iksiri

        // ---------------------------------------------------------
        // REGIONS (GameWorld Service)
        // Prefix: b0000000-0000-0000-0000-00000000000x (hex 'b' geçerlidir)
        // ---------------------------------------------------------
