...
namespace Action.Infrastructure.Migrations
{
    ...
    [Migration("20260406110958_ExpandActionDefinition")]
    partial class ExpandActionDefinition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Action.Domain.Entities.ActionDefinition", b =>
                {
                    ...
                    b.Property<decimal>("RespectImpact")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("Action.Domain.Entities.GameSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Action.Domain.Entities.PlayerActionAttempt", b =>
                {
                    ...
                    b.ToTable("PlayerActionAttempts", null, t =>
                        {
                            t.Property("SuccessRate")
                                .HasColumnName("PlayerActionAttempt_SuccessRate");
                        });
                });

            modelBuilder.Entity("Action.Domain.Entities.PlayerEnergyState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ActiveBoostItem")
                        .HasColumnType("nvarchar(max)");
