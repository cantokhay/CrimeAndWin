...
namespace GameWorld.Application.Mapping
{
    public class GeneralMapping : Profile
    {
        public GeneralMapping()
        {
            ...
            CreateMap<Domain.Entities.Season, CreateSeasonDTO>()
            ...
            CreateMap<Domain.Entities.Season, ResultSeasonDTO>()
                .ForMember(d => d.StartUtc, m => m.MapFrom(s => s.DateRange.StartUtc))
                .ForMember(d => d.EndUtc, m => m.MapFrom(s => s.DateRange.EndUtc))
                .ReverseMap();
            ...
            CreateMap<Domain.Entities.Season, UpdateSeasonDTO>()
                .ForMember(d => d.GameWorldId, m => m.MapFrom(s => s.GameWorldId))
                .ForMember(d => d.StartUtc, m => m.MapFrom(s => s.DateRange.StartUtc))
                .ForMember(d => d.EndUtc, m => m.MapFrom(s => s.DateRange.EndUtc))
                .ReverseMap();
        }
